...
TEMP_C_MAX = 30.0         # hand-warmth is enough to breach (a few C over the
                          # ~27 C warmed idle) -> a cupped hand triggers a
                          # confirmed overheat alarm on stage
SOUND_MAX = 400.0         # loud acoustic event
